...
public class FoldableItemLayout extends FrameLayout {
    ...
    private PartView topPart;
    private PartView bottomPart;
    ...
    public FoldableItemLayout(@NonNull Context context) {
        super(context);
        init();
    }

    public FoldableItemLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public FoldableItemLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public FoldableItemLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
